...
- 🔒 **私有仓库同步** - 连接私有 GitHub/GitLab 仓库进行团队技能共享，支持更新检测
- 🏆 **贡献统计** - 通过徽章、等级和活动分析追踪用户贡献
- 🌟 **游戏化系统** - 通过提交、技能创建和社区参与获得徽章并升级
...
### 团队共享
![团队共享](docs/screenshots/ai-generation.png)
*私有仓库管理，支持团队协作*
...
**创建 GitLab PAT：**
- 访问 GitLab.com → Settings → Access Tokens
- 创建个人访问令牌，选择 `api` 范围
- 复制并粘贴到 skillsMN
...
- ✅ 无远程代码执行（无 eval()）
- ✅ 加密的凭据存储（平台特定）
- ✅ 支持自托管 GitLab 实例的证书处理

## 🆕 最新更新

**最新功能：**
- 🏆 **贡献统计** - 通过徽章和等级追踪您的贡献
- 🌟 **游戏化系统** - 通过提交、技能创建和社区参与获得徽章
- 🌐 **GitLab 支持** - 完整支持 GitLab.com 和自托管 GitLab 实例
- 👥 **团队分析** - 在私有仓库中查看团队贡献和技能活动
- 🔐 **增强安全性** - 改进的凭据管理和证书处理
- 📊 **活动追踪** - 实时统计和进度追踪
