...
class EditorPage extends AppPage_1.AppPage {
     ...
     */
    async closeWithConfirmation(keepChanges) {
        await this.page.keyboard.press('Control+w');
     ...
     */
    async selectSymlinkDirectory(directory) {
     ...
     */
    async areKeyboardShortcutsVisible() {
